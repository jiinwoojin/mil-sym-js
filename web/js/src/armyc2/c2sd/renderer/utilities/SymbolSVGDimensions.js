        ...
        if(schema === "G")
        {
            switch(true)
            {
                ...
                case (61005 === index || index === 61505)://  2525B only symbols
                        ...
                        break;
                case (59283 === index || index === 59294 || index === 59295 || index === 59296 || index === 59300 || index === 59301 ) :
                        rect = new Rectangle(-418,-1509,836,1509);
                        break;
                case (59215 <= index && index <= 59304):
                        rect = new Rectangle(-500,-500,1000,1000);
                        break;               
                case ((59305 <= index && index <= 59306) || (59308 <= index&& index <= 59317)):
                        rect = new Rectangle(-705,-480,1410,960);
                        break;                 
                case (59307 === index && index === 59307):
                        rect = new Rectangle(-480,-705,960,1410);
                        break;             
                case (59316 <= index && index <= 59317):
                        rect = new Rectangle(-500,-500,1000,1000);
                        break;     
                default:
                        break;
        ...
        if(schema === "W")
        {
            switch(true)
            {
                ...
                case (62063 === index)://ice crystals
                        //rect = new Rectangle(-180,-458,360,910);
                        rect = new Rectangle(-500,-230,1000,460);
                        break;
                ...
                case (62133 === index)://SHEARING OR SHEAR ZONE
                        //rect = new Rectangle(-698,-130,1396,260);
                        rect = new Rectangle(-328,-130,650,1000);
                        break;
                ...
                case (62183 === index)://Mud
                        ...
                        //rect = new Rectangle(-620,-440,835,875);
                        break;
                ...
                case (62187 === index)://gravel
                        ...
                        //rect = new Rectangle(-674,-702,1342,1459);
                        break;
                case (62188 === index)://pebbles
                        rect = new Rectangle(-480,-487,971,997);
                        //rect = new Rectangle(-440,-487,737,997);
                        break;
                ...
                case (62193 === index)://fine
                        ...
                        //rect = new Rectangle(-433,-603,500,1205);
                        break;
                case (62194 === index)://medium
                        rect = new Rectangle(-596,-400,1202,824);
                        //rect = new Rectangle(-580,-400,1078,824);
                        break;
                ...
                case (62203 === index)://PILE/PILING/POST
                        rect = new Rectangle(-405,-405,813,813);
                        break;
                case (60110 === index)://Instrument ceiling
                case (60111 === index)://Visual ceiling                        
                        rect = new Rectangle(-500,-500,1000,1000);
                        break; 
                case (62204 === index)://Wind plot                     
                        rect = new Rectangle(-500,-500,1000,1000);
                        break;
                default:
                        break;
