...
armyc2.c2sd.JavaRendererServer.RenderMultipoints.clsRenderer = {
        ...
        try {
            ...
            if (lineType === 243112000) {
                ...
                if (AM !== null) {
                    ...
                    tg.set_H1(strH1); */
                    tg.set_AM(strLeftRightMinMax);//20200221 
                    tg.set_XN(strH1);
                }
            }
            switch (lineType) {
                ...
                case 24322300:
                    ...
                    break; */
                    //20200226 getModifiers_AM_AN_X("X") -> getModifier("X") X, X1 IS NOT ARRAY(XN)
                    X = milStd.getModifier("X");
                    if (X !== null && X != "")
                        tg.set_X(Double.toString((X).doubleValue()));
                    X1 = milStd.getModifier("X1");                        
                    if (X1 !== null && X1 != "")
                        tg.set_X1(Double.toString((X1).doubleValue()));
                    break;
                case 22224000:
                case 22222000:
                case 22224001:
                ...
                case 22223000:
                    ...
                    if (X !== null && X.size() > 1)
                        tg.set_H1(Double.toString((X.get(1)).doubleValue()));
                    break; */
                    //20200224 get_H2() -> get_AM(), set_H2 -> set_AM()
                    if (AM !== null) {
                        var H2 = "";
                        for (j = 0; j < AM.size(); j++) {
                            H2 += AM.get(j).toString();
                    ...
                    tg.set_AM(Double.toString(maxWidthMeters) + "m");
                    X = milStd.getModifier("X");
                    if (X !== null && X != "")
                        tg.set_X(Double.toString((X).doubleValue()));
                    X1 = milStd.getModifier("X1");                        
            ...
            switch (lineType) {
                ...
                case 24362000:
                    ...
                    strX = "";
                    if (X !== null ) {
                        strX = Double.toString((X).doubleValue());
                        tg.set_X(strX);
                    }
                    break;
                default:
            ...
            if (lineType === 24311000 || lineType === 14000001 || lineType === 14000002) {
                ...
                if (AM !== null && AM.size() > 1 && AN !== null && AN.size() > 0) {
                    strT1 = Double.toString((AM.get(0)).doubleValue());//width
                    var strH = Double.toString((AM.get(1)).doubleValue());//length
                    tg.set_T1(strT1);
                    tg.set_H(strH);
                    var strH2 = Double.toString((AN.get(0)).doubleValue());
                    //tg.set_H2(strH2);
                    tg.set_AM(strH2);//20200221
                }
            }
    ...
    createTGLightFromMilStdSymbol: function (milStd, converter) {
        ...
        try {
            ...
            //20200220 add
            if (milStd.getModifier("A") !== null)
                tg.set_A(milStd.getModifier("A"));
			if (milStd.getModifier("B") !== null)
                tg.set_B(milStd.getModifier("B"));
			if (milStd.getModifier("C") !== null)
                tg.set_C(milStd.getModifier("C"));
            //20200226 X, X1 add NOT XN
            if (milStd.getModifier("X") !== null)
                tg.set_X(milStd.getModifier("X"));
            if (milStd.getModifier("X1") !== null)
                tg.set_X1(milStd.getModifier("X1"));
            ...
            if (lineType === 13000000 || lineType === 13000001 || lineType === 13000002)
            {
                ...
                if (AM !== null && AM.length >= 2 && AN !== null && AN.length >= 1)
                {
                    ...
                    tg.set_AM(Double.toString(AM[1]));   //semi-minor 20200224
            ...
            if (lineType === 243112000)
            {
                var AM = milStd.getModifiers_AM_AN_X(modifiersTG.AM_DISTANCE);
                var AN = milStd.getModifiers_AM_AN_X(modifiersTG.AN_AZIMUTH);
                var X = milStd.getModifiers_AM_AN_X(modifiersTG.XN_ALTITUDE_DEPTH);//20200226 X->XN
                if (AM !== null)
                {
                    var strT1 = "";
            ...
            switch (lineType) {
                ...
                case 24322300:
                    ...
                    {
                        //tg.set_H(X[0]);
                        x_alt = X * armyc2.c2sd.JavaRendererServer.RenderMultipoints.clsRenderer.feetPerMeter;
                        //strXAlt=Double.toString(x_alt)+" ft. "+altitudeLabel;
                        x_alt *= 10.0;
                        x_alt = Math.round(x_alt);
                        n_alt = x_alt;
                    ...
                    {
                        //tg.set_H1(X[1]);
                        x_alt = X1 * armyc2.c2sd.JavaRendererServer.RenderMultipoints.clsRenderer.feetPerMeter;
                        //strXAlt=Double.toString(x_alt)+" ft. "+altitudeLabel;
                        x_alt *= 10.0;
                        x_alt = Math.round(x_alt);
                        n_alt = x_alt;
                ...
                case 22223000:
                    ...
                    if (tg.get_AM() !== null && tg.get_AM().isEmpty() === false) {//20200224 get_H2() -> get_AM()
                        if (strRadii !== null && strRadii.length > 0) {
                            var pixels = 0;
                            for (j = 0; j < tg.Pixels.size(); j++) {
                                if (tg.Pixels.size() > j) {
                    ...
                    //tg.set_H2(Double.toString(maxWidthMeters) + "m");
                    tg.set_AM(Double.toString(maxWidthMeters) + "m");//20200221
                    /* X = milStd.getModifiers_AM_AN_X(modifiersTG.X_ALTITUDE_DEPTH);
                    if (X !== null && X.length > 0)
                    {
                        //tg.set_H(X[0]);
            ...
            {
                AM = milStd.getModifiers_AM_AN_X(modifiersTG.AM_DISTANCE);
                X = milStd.getModifiers_AM_AN_X(modifiersTG.XN_ALTITUDE_DEPTH);//20200226 X->XN
                var strH2 = "";
                strH1 = "";
                if (AM !== null)
                {
            ...
            if (lineType === 24311000 || lineType === 14000001 || lineType === 14000002) {
                ...
                {
                    strT1 = AM[0];//width
                    var strH = AM[1];//length
                    tg.set_T1(strT1);
                    tg.set_H(strH);
                    strH2 = AN[0];
                    tg.set_AM(strH2);//20200224 set_H2() -> set_AM()
                }
                if(AM !== null && AM.length > 2)
                {
...
//            }
            ...
            if (modifierShapeInfos !== null) {
                ...
                if(tg.modifiers.array.length > 0 ) {
	                tg.modifiers.array[0].type=2;//20200207
				}
