        ...
        try {
            ...
            switch (lineType) {
                case 13000001:
                    ...
                    width.value[0] = Double.parseDouble(tg.get_XN());       //semi-major axis //20200226 get_H1() -> get_XN()
                    //length.value[0] = Double.parseDouble(tg.get_H2());    //semi-minor axis
                    length.value[0] = Double.parseDouble(tg.get_AM());    //semi-minor axis //20200224 get_H2() -> get_AM()
                ...
                case 14000002:
                    ...
                    length.value[0] = Double.parseDouble(tg.get_H());
                    //value passed in mils
                    //attitude.value[0] = Double.parseDouble(tg.get_H2()) * (0.05625);
                    attitude.value[0] = Double.parseDouble(tg.get_AM()) * (0.05625); //20200224 get_H2() -> get_AM()
                    ...
                    if(std===armyc2.c2sd.renderer.utilities.RendererSettings.Symbology_2525C) {//value passed in degrees
                        ...
                        attitude.value[0] = Double.parseDouble(tg.get_AM()); //20200224 get_H2() -> get_AM()
                    }
                    break;
                case 24326101:
                case 24321200:
                ...
                case 25200101:
                    ...
                    if(armyc2.c2sd.renderer.utilities.SymbolUtilities.isNumber(tg.get_AM()))
                        attitude.value[0] = Double.parseDouble(tg.get_AM());
                    break;
                default:
                    break;
            }
    ...
    Change1TacticalAreas: function(tg, lineType, converter, shapes) {
        try {
            ...
            switch (lineType) {
                ...
                case 14000002:
                    ptTemp = armyc2.c2sd.JavaTacticalRenderer.mdlGeodesic.geodesic_coordinate(pt0, width.value[0] / 2, attitude.value[0] - 90);
                    ptTemp = armyc2.c2sd.JavaTacticalRenderer.mdlGeodesic.geodesic_coordinate(ptTemp, length.value[0] / 2, attitude.value[0] + 0);
                    ptTemp = armyc2.c2sd.JavaRendererServer.RenderMultipoints.clsUtilityCPOF.PointLatLongToPixels(ptTemp, converter);
                    tg.Pixels.add(ptTemp);
                    ptTemp = armyc2.c2sd.JavaTacticalRenderer.mdlGeodesic.geodesic_coordinate(pt0, width.value[0] / 2, attitude.value[0] + 90);
                    ptTemp = armyc2.c2sd.JavaTacticalRenderer.mdlGeodesic.geodesic_coordinate(ptTemp, length.value[0] / 2, attitude.value[0] + 0);
                    ...
                    tg.Pixels.add(ptTemp);
                    ptTemp = armyc2.c2sd.JavaTacticalRenderer.mdlGeodesic.geodesic_coordinate(pt0, width.value[0] / 2, attitude.value[0] + 90);
                    ptTemp = armyc2.c2sd.JavaTacticalRenderer.mdlGeodesic.geodesic_coordinate(ptTemp, length.value[0] / 2, attitude.value[0] + 180);
                    ptTemp = armyc2.c2sd.JavaRendererServer.RenderMultipoints.clsUtilityCPOF.PointLatLongToPixels(ptTemp, converter);
                    tg.Pixels.add(ptTemp);
                    ptTemp = armyc2.c2sd.JavaTacticalRenderer.mdlGeodesic.geodesic_coordinate(pt0, width.value[0] / 2, attitude.value[0] - 90);
                    ptTemp = armyc2.c2sd.JavaTacticalRenderer.mdlGeodesic.geodesic_coordinate(ptTemp, length.value[0] / 2, attitude.value[0] + 180);
                ...
                case 13000002:  //circle
                    ...
                    var semiMinor=parseFloat(tg.get_AM());//20200224 get_H2() -> get_AM()
...
//            }
    ...
    GetConcentricCircles: function(tg, lineType, converter) {
        try {
            ...
            var radii = null;
            //var H2 = tg.get_H2();
            var H2 = tg.get_AM();//20200224 get_H2() -> get_AM()
