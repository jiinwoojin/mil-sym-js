                            ...
                            switch (lineType) {
                                ...
                                case 31131300:
                                    if (k > 0) {
                                        ...
                                        nCounter++;
                                        // 한랭전선 소멸 cross line 각도 조절 20201211
...
//                            }
                    ...
                    switch (lineType) {
                        ...
                        // [K] Add Middle Arrow With Same Flow (Using Median Algorithm).
                        case 221231710:
                        case 221231720:
                            if (pLinePoints.length > 1) {
                                var pArr = pOriginalLinePoints.slice();
                                var lineStringVals = [];
                                for (var i = 0; i < pArr.length; i++) {
                                    var pt = converter.PixelsToGeo(new armyc2.c2sd.graphics2d.Point2D(pArr[i].x, pArr[i].y))
                                    lineStringVals.push([
                                        pt.x, pt.y
                                    ]);
                                }
                                ...
                                var pCen = new armyc2.c2sd.JavaLineArray.POINT2(along.geometry.coordinates[0], along.geometry.coordinates[1]);

                                var pt = converter.GeoToPixels(new armyc2.c2sd.graphics2d.Point2D(pCen.x, pCen.y));

                                var arr = [];
                                var mid = Math.floor(pArr.length / 2);
                                pArr.splice(mid, 0, pt);
                                for (var i = mid; i >= 0; i--) {
                                    arr.push(pArr[i]);
                                }
                                armyc2.c2sd.JavaLineArray.arraysupport.GetLineArray2Double(22522220, arr, 5, 2, shapes, clipBounds, rev);
                            }
                            break;
                        default:
                            break;
