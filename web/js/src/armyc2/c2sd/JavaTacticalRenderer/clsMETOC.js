        ...
        try {
            ...
            switch (tg.get_LineType()) {
                ...
                case 31840001:
                    ...
                    break;
                case 31790000:
                    tg.set_LineColor(new armyc2.c2sd.renderer.utilities.Color(214, 192, 131));
                    break;
                case 31740000:
                    tg.set_LineColor(new armyc2.c2sd.renderer.utilities.Color(165, 42, 42));
                    break;
...
//                        } 
                    ...
                    case 31440001:
                        if (array.size() > 1) {
                            ...
                            // [K] 초반부에 화살표 그려주기
                            if (i === 0) {
                                armyc2.c2sd.JavaTacticalRenderer.clsMETOC.DrawArrow(array.get(1), array.get(0), 10, lineObject);
                            }

                            if (i > 1) {
                                lineObject.moveTo(Math.floor(array.get(i).x, array.get(i).y));
                                armyc2.c2sd.JavaTacticalRenderer.clsMETOC.DrawArrow(array.get(i), array.get(i - 1), 10, lineObject);
                            }
