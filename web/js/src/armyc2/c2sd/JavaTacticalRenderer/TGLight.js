...
armyc2.c2sd.JavaTacticalRenderer.TGLight = function () {
    ...
    this.h1 = "";
    this.y = "";
    this.n = ""; //this.n = "ENY"; //20200128 annotation processing    
    this.h2 = "";
    this.w = "";
    this.w1 = "";
    this.a = ""; //20200220 add but not working
    this.b = ""; //20200220 add but not working
    this.c = ""; //20200220 add 2.2.1.2.31.5, 2.2.1.2.31.6
    this.x = "";
    this.x1 = "";
    this.xn = "";//20200226 xn add 
    this.am = "";
    ...
    this.symbolId = null;
    this.status = null;
    this.visibleModifiers = true;//20200110 bitlove27
...
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.get_T = function () {
    if (this.visibleModifiers)
        return this.t;
    else
        return "";
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.set_T = function (value) {
    this.t = value;
};
...
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.get_A = function () {
    return this.a;
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.set_A = function (value) {
    this.a = value;
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.get_B = function () {
    return this.b;
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.set_B = function (value) {
    this.b = value;
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.get_C = function () {
    return this.c;
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.set_C = function (value) {
    this.c = value;
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.get_X = function () {
    return this.x;
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.set_X = function (value) {
    this.x = value;
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.get_X1 = function () {
    return this.x1;
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.set_X1 = function (value) {
    this.x1 = value;
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.get_XN = function () {
    return this.xn;
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.set_XN = function (value) {
    this.xn = value;
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.get_AM = function () {
    return this.am;
};
armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.set_AM = function (value) {
    this.am = value;
};
...
// symbolId set 함수.
// symbolId에 부대규모(code 12번째 자리) 정보가 있으면, echelon 및 echlonSymbol set도 동시에 이뤄짐.
