...
armyc2.c2sd.JavaTacticalRenderer.clsUtility = {
    ...
    ResolveModifierShape: function (tg, shape) {
        try {
            ...
            switch (tg.get_LineType()) {
                ...
                case 22528000:
                case 221231200:
                case 221231600://20200221 dotted line add
                case 23191000:
                case 24222000:
                case 23224000:
                    if (shape.getShapeType() === armyc2.c2sd.JavaLineArray.Shape2.SHAPE_TYPE_POLYLINE) {
    ...
    GetSectorRadiiFromPoints: function (tg) {
        try {
            ...
            if (tg.LatLongs.size() > 2) {
                ...
                if (!temp.equals("")) {
                    //tg.set_H2(temp);
                    tg.set_AM(temp);//20200224 set_H2() -> set_AM()
                }
            }
        } catch (exc) {
            if (Clazz.instanceOf(exc)) {
    ...
    initializeLinetypes: function (rev) {
        try {
            ...
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*TPUP----****X", (212240000));
            ...
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGLA---****X", (22126000));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGLE---****X", (22128000));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGL2---****X", (221228000));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGL3---****X", (221229000));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGL4---****X", (221230000));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGL5L--****X", (221231100));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGL5W--****X", (221231200));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGL6---****X", (221232000));
            ...
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPAAP---****X", (22236000));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPAAA---****X", (22237000));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPAAT---****X", (22238000));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPAAO---****X", (22239000));
            ...
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPDLA---****X", (22423000));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPDLB---****X", (22424000));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPDLC---****X", (22425000));
            ...
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPDAF---****X", (22433000));
            ...
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPSLAA--****X", (22611100));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPSLAB--****X", (22611200));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPSLAC--****X", (22611300));
            ...
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*MOMTA---****X", (23152100));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*MOMPA---****X", (23155100));
            ...
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*MPOWCA--****X", (231117400));
            ...
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*FPACCI--****X", (243213100));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*FPACGI--****X", (243214100));
            ...
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*SPLRB---****X", (25226000));
            ...
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*SPASA---****X", (25354000));
            ...
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGL5C--****X", (221231500));//20200218 add start
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGL5D--****X", (221231600));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGL5EM-****X", (221231710));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGL5EA-****X", (221231720));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGABB--****X", (221312100));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*GPGABH--****X", (221312200));
            if (rev === 1) {
                ...
                armyc2.c2sd.JavaTacticalRenderer.clsUtility.linetypes.put("G*TPUP----****X", (212240001));
            ...
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.metocs.put("WA--FI---------", (311010000));
            armyc2.c2sd.JavaTacticalRenderer.clsUtility.metocs.put("WA--FV---------", (311020000));
